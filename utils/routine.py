...
def plural_form(n, v, crop=False, fmt=False):
    ...
    num = f"{n:,}" if fmt else str(n)
    
    return f"{num}{v[2 if (4 < n % 100 < 20) else (2, 0, 1, 1, 1, 2)[min(n % 10, 5)]][0]}." if crop else f"{num} {v[2 if (4 < n % 100 < 20) else (2, 0, 1, 1, 1, 2)[min(n % 10, 5)]]}"
