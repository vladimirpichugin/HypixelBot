...
class HypixelOnlinePlugin(CommandPlugin):
    ...
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=10, ):
        """Player session command."""
        self.description = ["Игрок онлайн Hypixel"]

        self.timeout = timeout
        self.api_command = "session"
        
        super().__init__(*commands, prefixes=prefixes, strict=strict, required_role=required_role)
        
        example = self.command_example()
        self.help_message = f"Онлайн статус игрока\n{example} [ник/вк]"
