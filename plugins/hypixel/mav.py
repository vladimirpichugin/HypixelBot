...
class HypixelMAVPlugin(CommandPlugin):
    __slots__ = ("description", "timeout", "api_command", "api_url", "api_headers", "help_message", )
    
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=10, ):
        """Player stats command."""
        self.description = ["База аккаунтов Minecraft"]

        self.timeout = timeout
        self.api_command = "mav"
        
        super().__init__(*commands, prefixes=prefixes, strict=strict, required_role=required_role)
        
        example = self.command_example()
        self.help_message = f"MAV-Аккаунт игрока\n\nИспользование: {example} [ник/вк]"
    ...
    async def process_message(self, msg):
        ...
        await msg.answer("&#128640; Поиск аккаунта..")
