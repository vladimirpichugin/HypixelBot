...
class RuGamingBalancePlugin(CommandPlugin):
    ...
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=120, ):
        """RuGaming Member Balance"""
        self.description = ["RuGaming Member Balance"]
        
        self.timeout = timeout
        self.api_command = "rugaming_guild_balance"
    ...
    async def process_message(self, msg):
        ...
        await msg.answer("&#128640; Загрузка баланса..")
