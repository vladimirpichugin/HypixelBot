...
class RuGamingRolePlugin(CommandPlugin):
    ...
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=120, ):
        """RuGaming Member Role"""
        self.description = ["RuGaming Member Role"]
        
        self.timeout = timeout
        self.api_command = "rugaming_guild_role"
    ...
    async def process_message(self, msg):
        ...
        await msg.answer("&#128640; Загрузка роли..")
