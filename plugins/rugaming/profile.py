...
class RuGamingProfilePlugin(CommandPlugin):
    ...
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=120, ):
        """RuGaming Member Profile"""
        self.description = ["RuGaming Member Profile"]
        
        self.timeout = timeout
        self.api_command = "rugaming_guild_profile"
    ...
    async def process_message(self, msg):
        ...
        await msg.answer("&#128640; Загрузка участника..")
