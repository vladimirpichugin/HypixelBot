...
class RuGamingGexpTopPlugin(CommandPlugin):
    ...
    def __init__(self, *commands, prefixes=None, strict=False, required_role=None, timeout=120, ):
        """RuGaming Member G-Exp Top"""
        self.description = ["RuGaming Member G-Exp Top"]
        
        self.timeout = timeout
        self.api_command = "rugaming_guild_gexp_top"
    ...
    async def process_message(self, msg):
        ...
        await msg.answer("&#128640; Загрузка топа G-Exp..")
        
        try:
            params = {
                "cmd": self.api_command,
                "args": cmd_args,
                "payload": json.dumps(msg.meta["payload_obj"]) if msg.meta["payload_obj"] else '',
                "user_id": msg.user_id,
